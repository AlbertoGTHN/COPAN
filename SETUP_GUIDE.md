# COPAN — Classification-Oriented Phishing Analysis Network — Complete Setup Guide
...
git init
git add .
git commit -m "Initial commit: COPAN — Classification-Oriented Phishing Analysis Network"

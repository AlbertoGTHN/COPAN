"""
Rigorous Evaluation Script — COPAN — Classification-Oriented Phishing Analysis Network
==========================================================
...
def main() -> None:
    ...
    print(f"\n{_SEP}")
    print("  COPAN — Classification-Oriented Phishing Analysis Network — Evaluation")
    print(_SEP)

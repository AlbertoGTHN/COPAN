"""Generate technical documentation PDF for the COPAN — Classification-Oriented Phishing Analysis Network."""
...
def build_pdf():
    ...
    story.append(Paragraph("COPAN — Classification-Oriented Phishing Analysis Network", styles['DocTitle']))
    ...
    story.append(Paragraph(
        "COPAN v1.0 — Classification-Oriented Phishing Analysis Network -- Based on research by Loo, Galindo, Romero et al. -- "

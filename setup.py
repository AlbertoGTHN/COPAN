"""
One-command setup script for the COPAN — Classification-Oriented Phishing Analysis Network.
...
def main():
    print("=" * 50)
    print("  COPAN — Classification-Oriented Phishing Analysis Network — Setup")
    print("=" * 50)

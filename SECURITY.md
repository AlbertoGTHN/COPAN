# Security Hardening — COPAN — Classification-Oriented Phishing Analysis Network
...
*Loo, Galindo, Romero et al. — "Adversarial Robustness of COPAN — Classification-Oriented Phishing Analysis Network"*

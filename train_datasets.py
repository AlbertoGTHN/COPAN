"""
Multi-Dataset Training Script — COPAN — Classification-Oriented Phishing Analysis Network.
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("  Multi-Dataset Trainer — COPAN — Classification-Oriented Phishing Analysis Network")
    logger.info("=" * 60)
